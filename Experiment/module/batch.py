...
class Batch:
    ...
    def __init__(self, pricer: Callable, extra_output_function: str):
...
class DualDigitalBatch(Batch):
    ...
    def __init__(self, pricer: Callable, extra_output_function: str):
        super().__init__(pricer, extra_output_function)
    ...
    def build_static_rolling_batch(self,
                                   ...
                                   rho: float, r: float, notional: int, model: str) -> None:
        ...
        rolling_batch = rolling_batch.drop(labels='time_to_roll', axis=1)
